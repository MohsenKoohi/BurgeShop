	...
	<div class="container">
		...
		<div class="row general-buttons">
			<div class="three columns">
				<?php echo form_open(get_link("admin_product_category"),array()); ?>
		...
		<?php if(sizeof($categories)>1){ ?>
			<div class="container category-list">
					...
					?>				
						<div class="three columns cat" data-cat-id="<?php echo $cat['id'];?>" >
							<div>
								...
								<div class="name">
									<a target="_blank" href="<?php echo get_admin_product_category_details_link($cat['id']);?>">
										<b>
											<?php 
				...
				<?php echo form_open(get_link("admin_product_category"),array("id"=>"resort")); ?>
