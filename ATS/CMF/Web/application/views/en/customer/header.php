...
<body class="ltr customer-env" style="height:100%;">
  <div class="header">
           ...
           <ul class="side-menu-ul">
            <?php 
              foreach($sidebar_product_categories as $cat)
              {
                ...
                $link=get_customer_product_category_details_link($id,$cat['hash'],$cat['urls'][$selected_lang]);
                ...
                if($cat['children'])
                {
                  ...
                  foreach($cat['children'] as $child)
                  {
                    ...
                    $link=get_customer_product_category_details_link($id,$child['hash'],$child['urls'][$selected_lang]);
                    echo "<li><a href='$link'>$name</a>\n";
                  }
                  echo "</ul>\n";
                }
