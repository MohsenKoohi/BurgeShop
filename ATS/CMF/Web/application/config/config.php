...
|
*/
$config['subclass_prefix'] = 'Burge_CMF_';
...
|
*/
$config['encryption_key'] = 'Ye2t6O9Sx28tModdtN3w';
/*
|--------------------------------------------------------------------------
| Session Variables
|--------------------------------------------------------------------------
...
$config['sess_cookie_name'] = SESSION_VARS_PREFIX.'34tat43grsdfg3er';
...
$config['sess_time_to_update']	= 5*60;
